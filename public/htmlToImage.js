        ...
        return e = [], i = [], t.forEach((function (e) {
          if ("cssRules" in e) try {
            ...
            null != e.href && i.push(B(e.href).then((function (t) {
              ...
              console.log("Error loading remote stylesheet", t?.message)
            }))), console.log("Error inlining remote css file", o?.message)
          }
          ...
          return t.forEach((function (t) {
            if ("cssRules" in t) try {
              ...
              console.log("Error while reading CSS rules from ".concat(t.href), e?.message)
            }
          })), e
        }))]
      }))
      ...
      return n(this, (function (n) {
        switch (n.label) {
          ...
          case 2:
            ...
            }(s), s.style.width = "".concat(d), s.style.height = "".concat(v), r.backgroundColor && (f.fillStyle = r.backgroundColor, f.fillRect(0, 0, s.width, s.height)), f.scale(r.scale, r.scale), s.width = Math.floor(s.width * r.scale), s.height = Math.floor(s.height * r.scale), f.drawImage(u, 0, 0, s.width, s.height), [2, s]
        }
      }))
    }))
  }
